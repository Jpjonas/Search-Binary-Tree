...
${OBJECTDIR}/TDA/ABB.o: TDA/ABB.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA/ABB.o TDA/ABB.c

${OBJECTDIR}/TDA/ABB.o: TDA/ABB.h 
	${MKDIR} -p ${OBJECTDIR}/TDA
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA/ABB.o TDA/ABB.h

${OBJECTDIR}/TDA/ABB_priv.o: TDA/ABB_priv.c 
	${MKDIR} -p ${OBJECTDIR}/TDA
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA/ABB_priv.o TDA/ABB_priv.c

${OBJECTDIR}/TDA/ABB_priv.o: TDA/ABB_priv.h 
	${MKDIR} -p ${OBJECTDIR}/TDA
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA/ABB_priv.o TDA/ABB_priv.h
